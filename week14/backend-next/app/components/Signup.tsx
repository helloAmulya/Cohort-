        ...
        <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 ">
          <div>
            ...
            <div className="pt-2">
              ...
              <button className='font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 bg-blue-300 mt-8 w-full text-white' onClick={() => signup(username, password)}>Sign In</button>
